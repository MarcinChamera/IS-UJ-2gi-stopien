...
public interface RAIDInterface {
	...
	/**
	 * Typ wyliczeniowy reprezentujÄcy stany macierzy dyskowej RAID.
	 */
	 ...
	 * przed innymi metodami tego samego interfejsu. KolejnoĹÄ dodawanych dyskĂłw
	 * jest wiÄĹźÄca. Ostatni z dodanych dyskĂłw przeznaczony jest na dane nadmiarowe.
	 * 
	...
	/**
	 * Metoda rozpoczyna dziaĹanie macierzy RAID. Przed jej uĹźyciem nie wolno
	 * odczytywaÄ/zapisywaÄ danych na dyskach.
	 */
	 ...
	 * 
	 * @param disk sprawny dysk zastÄpujÄcy dysk uszkodzony.
	 */
	...
	/**
	 * Rozmiar dysku logicznego, ktory powstaje po utworzeniu z dyskĂłw "fizycznych"
